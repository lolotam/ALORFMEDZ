...
from utils.database import get_consumption, save_consumption, update_consumption, delete_consumption, log_activity, get_patients, get_departments, get_medicines, get_stores, load_data
...
def edit(consumption_id):
    """Edit consumption"""
    from utils.database import get_consumption, save_consumption, update_consumption, delete_consumption, log_activity
