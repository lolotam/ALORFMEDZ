...
from utils.database import get_departments, save_department, update_department, delete_department, get_users, get_consumption, log_activity, save_department_with_user
