...
from app.utils.database import get_suppliers, save_supplier, update_supplier, delete_supplier, get_medicines, log_activity
...
def bulk_delete():
    ...
    try:
        ...
        if deleted_count > 0:
            from app.utils.database import renumber_ids, cascade_update_supplier_references
